package com.etologic.elrefugioapp.android.main.fragments.adopt
...
class AdoptFragment : MainBaseFragment() {
    ...
    private fun loadWebView(view: View) {
        val webView: WebView = view.findViewById(R.id.wvAdopt)
        ...
        webView.loadUrl(getString(R.string.url_adopt))
    }
}
